...
public class AdditionalParameterRegExTest {
  ...
  public void testSingleParameter() throws Exception {
    AbstractMap.SimpleEntry<String, String> test1 =
  ...
  public void testInvalidParameter() throws Exception {
    AbstractMap.SimpleEntry<String, String> test1 =
        StashRepository.getParameter("p:if apa=Nickesocke");
    assert (test1 == null);
    AbstractMap.SimpleEntry<String, String> test2 =
        StashRepository.getParameter("p:apa==Nickesocke");
    assert (test2 != null
        && test2.getKey().equals("apa")
        && test2.getValue().equals("=Nickesocke"));
    AbstractMap.SimpleEntry<String, String> test3 =
